...
impl<F: Field> Sha2TraceGenerator<F> {
    ...
    pub fn gen_hash<const N: usize>(&mut self, his0: [u32; 8],  left_input: [u32; 16 * N]) -> [u32; 8] {
        let mut his = his0;
        for i in 0..N {
...
mod tests {
    ...
    fn test_hash_of_zero() {
        ...
        let his = generator.gen_hash::<1>(HASH_IV, left_input);
    ...
    fn test_hash_of_h3() {
        ...
        let his = generator.gen_hash::<N>(HASH_IV, left_input);
    ...
    #[test]
    fn test_hash_of_h3_with_generate() {
        let block0 = decode_hex("").unwrap();
        assert!(block0.len() % 64 == 0);
        assert!((block0.len() / 64) == 49);
        const N: usize = 49;
        ...
        for i in 0..N {
            ...
            his = generator.gen_hash::<1>(his, left_input0);
            print!("\nfinal hash : ");
            for i in 0..8 {
                let x = his[i];
                print!("{:x}", x);
